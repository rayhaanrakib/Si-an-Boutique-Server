...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.eatmzap.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
async function run() {
    try {
        ...
        app.post('/products', async (req, res) => {
            ...
            const result = await productsData.insertOne(newProduct);
            res.send(result);
        })
